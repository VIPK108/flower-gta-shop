  ...
  <div class="container-fluid">
    <div class="row border p-1 bg-white"><div id="carouselExampleControls"  class="carousel slide" data-bs-ride="carousel"><div class="carousel-inner" ><div  class="carousel-item active"  id="first" style="max-height:400px; min-height: 400px;" >
                      <div class="d-flex " style="height: 400px;" >
                        <img src="rukminim2.flixcart.com/image/416/416/xif0q/headphone/1/x/j/-original-imagsgfbgrfhy7vm2fe1.jpg?q=70&amp;crop=false" class="d-block img-fluid m-auto" alt="Product Image" id="active">

                      </div>
                    </div><div  class="carousel-item"  id="" style="max-height:400px; min-height: 400px;" >
                      <div class="d-flex " style="height: 400px;" >
                        <img src="rukminim2.flixcart.com/image/416/416/xif0q/headphone/b/e/n/-original-imagsgfbhsfrsn4f2fe1.jpg?q=70&amp;crop=false" class="d-block img-fluid m-auto" alt="Product Image" id="">

                      </div>
                    </div><div  class="carousel-item"  id="" style="max-height:400px; min-height: 400px;" >
                      <div class="d-flex " style="height: 400px;" >
                        <img src="rukminim2.flixcart.com/image/416/416/xif0q/headphone/7/m/c/-original-imagsgfbwuxrpgs92fe1.jpg?q=70&amp;crop=false" class="d-block img-fluid m-auto" alt="Product Image" id="">

                      </div>
                    </div><div  class="carousel-item"  id="" style="max-height:400px; min-height: 400px;" >
                      <div class="d-flex " style="height: 400px;" >
                        <img src="rukminim2.flixcart.com/image/416/416/xif0q/headphone/w/i/f/-original-imagsgfbq8hgf4fp2fe1.jpg?q=70&amp;crop=false" class="d-block img-fluid m-auto" alt="Product Image" id="">

                      </div>
                    </div><div  class="carousel-item"  id="" style="max-height:400px; min-height: 400px;" >
                      <div class="d-flex " style="height: 400px;" >
                        <img src="rukminim2.flixcart.com/image/416/416/xif0q/headphone/g/a/6/-original-imagsgfb4hjn9nzd2fe1.jpg?q=70&amp;crop=false" class="d-block img-fluid m-auto" alt="Product Image" id="">

                      </div>
                    </div><div  class="carousel-item"  id="" style="max-height:400px; min-height: 400px;" >
                      <div class="d-flex " style="height: 400px;" >
                        <img src="rukminim2.flixcart.com/image/416/416/xif0q/headphone/b/l/4/-original-imagsgfbgpt5xhhq2fe1.jpg?q=70&amp;crop=false" class="d-block img-fluid m-auto" alt="Product Image" id="">

                      </div>
                    </div><div  class="carousel-item"  id="" style="max-height:400px; min-height: 400px;" >
                      <div class="d-flex " style="height: 400px;" >
                        <img src="rukminim2.flixcart.com/image/416/416/xif0q/headphone/h/c/3/-original-imagsgfbqygkh7vb2fe1.jpg?q=70&amp;crop=false" class="d-block img-fluid m-auto" alt="Product Image" id="">

                      </div>
                    </div><div  class="carousel-item"  id="" style="max-height:400px; min-height: 400px;" >
                      <div class="d-flex " style="height: 400px;" >
                        <img src="rukminim2.flixcart.com/image/416/416/xif0q/headphone/v/m/5/-original-imagsgfb4jzrcfb82fe1.jpg?q=70&amp;crop=false" class="d-block img-fluid m-auto" alt="Product Image" id="">
                      ...
                      <div class="d-flex " style="height: 400px;" >
                        <img src="#" class="d-block img-fluid m-auto" alt="Product Image" id="">
                              ...
                              <img class="img-fluid mb-2" style="max-width: 70px;" id="0" src="rukminim2.flixcart.com/image/416/416/xif0q/headphone/1/x/j/-original-imagsgfbgrfhy7vm2fe1.jpg?q=70&amp;crop=false" alt="">
                              <p class="mb-0">blue</p>
              ...
              <div class="row p-2 my-2 bg-white">
                ...
                <div class="d-flex">
                  <h5 class="me-2 fw-bold " style="">₹139</h5>
...
<script>
      ...
      <div class="fixed-bottom row  " style="box-shadow: 2px 2px 5px rgba(0, 0, 0, 0.459);">
         <div class="position-relative d-flex">
            ...
            <a href="cart.php?item=21&amp;price=139&amp;originalPrice=3199&amp;title=realme%20Buds%20Air%205%20with%2050dB%20ANC,%2012.4mm%20Dynamic%20Bass%20Driver%20and%20upto%2038%20hours%20Playback%20Bluetooth%20Headset%20(Deep%20Sea%20Blue,%20True%20Wireless)&amp;image=rukminim2.flixcart.com/image/416/416/xif0q/headphone/1/x/j/-original-imagsgfbgrfhy7vm2fe1.jpg" id="cart" class="stretched-link"></a>     
         </div>
      </div>
