  ...
  <div class="container-fluid">
    <div class="row border p-1 bg-white"><div id="carouselExampleControls"  class="carousel slide" data-bs-ride="carousel"><div class="carousel-inner" ><div  class="carousel-item active"  id="first" style="max-height:400px; min-height: 400px;" >
                      <div class="d-flex " style="height: 400px;" >
                        <img src="rukminim2.flixcart.com/image/416/416/xif0q/speaker/soundbar/s/c/1/orion-boat-original-imagtvgsvga2rrmf2fe1.jpg?q=70&amp;crop=false" class="d-block img-fluid m-auto" alt="Product Image" id="active">

                      </div>
                    </div><div  class="carousel-item"  id="" style="max-height:400px; min-height: 400px;" >
                      <div class="d-flex " style="height: 400px;" >
                        <img src="rukminim2.flixcart.com/image/416/416/xif0q/speaker/soundbar/s/9/c/orion-boat-original-imagtvgswstnkpwh2fe1.jpg?q=70&amp;crop=false" class="d-block img-fluid m-auto" alt="Product Image" id="">

                      </div>
                    </div><div  class="carousel-item"  id="" style="max-height:400px; min-height: 400px;" >
                      <div class="d-flex " style="height: 400px;" >
                        <img src="rukminim2.flixcart.com/image/416/416/xif0q/speaker/soundbar/h/l/h/orion-boat-original-imagtvgsyvh4gyet2fe1.jpg?q=70&amp;crop=false" class="d-block img-fluid m-auto" alt="Product Image" id="">

                      </div>
                    </div><div  class="carousel-item"  id="" style="max-height:400px; min-height: 400px;" >
                      <div class="d-flex " style="height: 400px;" >
                        <img src="rukminim2.flixcart.com/image/416/416/xif0q/speaker/soundbar/n/m/e/orion-boat-original-imagtvgsmkcyjkhj2fe1.jpg?q=70&amp;crop=false" class="d-block img-fluid m-auto" alt="Product Image" id="">

                      </div>
                    </div><div  class="carousel-item"  id="" style="max-height:400px; min-height: 400px;" >
                      <div class="d-flex " style="height: 400px;" >
                        <img src="rukminim2.flixcart.com/image/416/416/xif0q/speaker/soundbar/i/l/o/orion-boat-original-imagtvgsdhjc9dhz2fe1.jpg?q=70&amp;crop=false" class="d-block img-fluid m-auto" alt="Product Image" id="">
                              ...
                              <img class="img-fluid mb-2" style="max-width: 70px;" id="0" src="rukminim2.flixcart.com/image/416/416/xif0q/speaker/soundbar/s/c/1/orion-boat-original-imagtvgsvga2rrmf2fe1.jpg?q=70&amp;crop=false" alt="">
              ...
              <div class="row p-2 my-2 bg-white">
                ...
                <div class="d-flex">
                  <h5 class="me-2 fw-bold " style="">₹279</h5>
...
<script>
      ...
      <div class="fixed-bottom row  " style="box-shadow: 2px 2px 5px rgba(0, 0, 0, 0.459);">
         <div class="position-relative d-flex">
            ...
            <a href="cart.php?item=19&amp;price=279&amp;originalPrice=8499&amp;title=boAt%20Aavante%20Bar%20Orion%20with%20Multiple%20Connectivity%20Ports,%20EQ%20Modes%20160%20W%20Bluetooth%20Soundbar%20(Pitch%20Black,%202.1%20Channel)&amp;image=rukminim2.flixcart.com/image/416/416/xif0q/speaker/soundbar/s/c/1/orion-boat-original-imagtvgsvga2rrmf2fe1.jpg" id="cart" class="stretched-link"></a>     
         </div>
      </div>
