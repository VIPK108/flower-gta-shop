  ...
  <div class="container-fluid">
    <div class="row border p-1 bg-white"><div id="carouselExampleControls"  class="carousel slide" data-bs-ride="carousel"><div class="carousel-inner" ><div  class="carousel-item active"  id="first" style="max-height:400px; min-height: 400px;" >
                      <div class="d-flex " style="height: 400px;" >
                        <img src="rukminim2.flixcart.com/image/416/416/xif0q/air-cooler/e/d/7/-original-imaghr9u2bghnxuh2fe1.jpg?q=70&amp;crop=false" class="d-block img-fluid m-auto" alt="Product Image" id="active">

                      </div>
                    </div><div  class="carousel-item"  id="" style="max-height:400px; min-height: 400px;" >
                      <div class="d-flex " style="height: 400px;" >
                        <img src="rukminim2.flixcart.com/image/416/416/xif0q/air-cooler/q/2/v/-original-imaghr9uw5pxdmnk2fe1.jpg?q=70&amp;crop=false" class="d-block img-fluid m-auto" alt="Product Image" id="">

                      </div>
                    </div><div  class="carousel-item"  id="" style="max-height:400px; min-height: 400px;" >
                      <div class="d-flex " style="height: 400px;" >
                        <img src="rukminim2.flixcart.com/image/416/416/xif0q/air-cooler/1/z/f/-original-imaghr9uqhsyngez2fe1.jpg?q=70&amp;crop=false" class="d-block img-fluid m-auto" alt="Product Image" id="">

                      </div>
                    </div><div  class="carousel-item"  id="" style="max-height:400px; min-height: 400px;" >
                      <div class="d-flex " style="height: 400px;" >
                        <img src="rukminim2.flixcart.com/image/416/416/xif0q/air-cooler/o/s/g/-original-imaghr9un57cfwyr2fe1.jpg?q=70&amp;crop=false" class="d-block img-fluid m-auto" alt="Product Image" id="">

                      </div>
                    </div><div  class="carousel-item"  id="" style="max-height:400px; min-height: 400px;" >
                      <div class="d-flex " style="height: 400px;" >
                        <img src="rukminim2.flixcart.com/image/416/416/xif0q/air-cooler/t/h/l/-original-imaghr9ud4cw6amz2fe1.jpg?q=70&amp;crop=false" class="d-block img-fluid m-auto" alt="Product Image" id="">

                      </div>
                    </div><div  class="carousel-item"  id="" style="max-height:400px; min-height: 400px;" >
                      <div class="d-flex " style="height: 400px;" >
                        <img src="index.html" class="d-block img-fluid m-auto" alt="Product Image" id="">
                              ...
                              <img class="img-fluid mb-2" style="max-width: 70px;" id="0" src="rukminim2.flixcart.com/image/416/416/xif0q/air-cooler/e/d/7/-original-imaghr9u2bghnxuh2fe1.jpg?q=70&amp;crop=false" alt="">
              ...
              <div class="row p-2 my-2 bg-white">
                ...
                <div class="d-flex">
                  <h5 class="me-2 fw-bold " style="">₹459</h5>
...
<script>
      ...
      <div class="fixed-bottom row  " style="box-shadow: 2px 2px 5px rgba(0, 0, 0, 0.459);">
         <div class="position-relative d-flex">
            ...
            <a href="cart.php?item=17&amp;price=349&amp;originalPrice=46999&amp;title=Hindware%2045%20L%20Room%2FPersonal%20Air%20Cooler%20(Black%20%26%20White%2C%20XENO)&amp;image=rukminim2.flixcart.com/image/416/416/xif0q/air-cooler/e/d/7/-original-imaghr9u2bghnxuh2fe1.jpg" id="cart" class="stretched-link"></a>     
         </div>
      </div>
